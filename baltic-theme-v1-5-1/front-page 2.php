...
<section class="border-b border-slate-800 bg-gradient-to-b from-slate-950 to-slate-900">
  <div class="relative">
  <div class="aspect-[4/3] rounded-2xl overflow-hidden border border-slate-800 bg-slate-900/40 shadow-xl shadow-emerald-500/10">
    <!-- subtle gradient + pattern feel -->
    <div class="absolute inset-0 bg-gradient-to-br from-slate-950/10 via-slate-950/60 to-slate-950/90"></div>

    <!-- accents (no hard “example” content) -->
    <div class="absolute -top-10 -right-10 h-40 w-40 rounded-full bg-emerald-400/20 blur-2xl"></div>
    <div class="absolute -bottom-12 -left-12 h-48 w-48 rounded-full bg-amber-400/10 blur-2xl"></div>
    ...
    <div class="relative h-full p-6 flex flex-col justify-end">
      <div class="rounded-2xl border border-slate-800 bg-slate-950/40 p-4">
        ...
        <ul class="text-sm text-slate-200 space-y-2">
          <li class="flex gap-2"><span class="text-amber-400">✓</span><span>Clear quotes, no sales reps</span></li>
          <li class="flex gap-2"><span class="text-amber-400">✓</span><span>Neat installs &amp; proper certification</span></li>
          <li class="flex gap-2"><span class="text-amber-400">✓</span><span>Aftercare you can actually reach</span></li>
        </ul>
      </div>
    </div>
  </div>
