...
<!-- Brands / Accreditations strip (full width + scrolling loop) -->
<section class="border-b border-slate-800 bg-slate-950">
  <div class="w-full px-4 sm:px-6 lg:px-8 py-12">
    <div class="max-w-6xl mx-auto">
      ...
      <!-- Bubble container (NO Tailwind border classes here) -->
      <div class="be-marquee rounded-2xl px-2">
        <div class="be-marquee-track" aria-label="Brands and accreditations">

          <!-- SET 1 -->
          <div class="be-marquee-group">
            <div class="be-marquee-item hover-card rounded-2xl border border-slate-800 bg-slate-900/60 px-6 py-5 flex items-center justify-center">
              <img src="https://1xu.5eb.myftpupload.com/wp-content/uploads/2025/12/givenergy-logo-scaled.png" alt="GivEnergy" class="h-10 md:h-12 w-auto" />
            </div>

            <div class="be-marquee-item hover-card rounded-2xl border border-slate-800 bg-slate-900/60 px-6 py-5 flex items-center justify-center">
              <img src="https://1xu.5eb.myftpupload.com/wp-content/uploads/2025/12/Growatt-logo-new-GB.png" alt="Growatt" class="h-10 md:h-12 w-auto" />
            </div>

            <div class="be-marquee-item hover-card rounded-2xl border border-slate-800 bg-slate-900/60 px-6 py-5 flex items-center justify-center">
              <img src="https://1xu.5eb.myftpupload.com/wp-content/uploads/2025/12/napitlogo.webp" alt="NAPIT registered" class="h-10 md:h-12 w-auto" />
            </div>

            <div class="be-marquee-item hover-card rounded-2xl border border-slate-800 bg-slate-900/60 px-6 py-5 flex items-center justify-center">
              <img src="https://1xu.5eb.myftpupload.com/wp-content/uploads/2025/12/trustmark.webp" alt="TrustMark" class="h-10 md:h-12 w-auto" />
            </div>

            <div class="be-marquee-item hover-card rounded-2xl border border-slate-800 bg-slate-900/60 px-6 py-5 flex items-center justify-center">
              <img src="https://1xu.5eb.myftpupload.com/wp-content/uploads/2025/12/MCSCertifiedMark_BLACK_RGB-1848918833.png" alt="MCS certified" class="h-10 md:h-12 w-auto" />
            </div>
          </div>
